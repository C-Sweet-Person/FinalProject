 ...
 * Is going to go. I use a javascript
 * Implemenation since I can do it 
 * live basically.
 */
  function search() {
...
function addressAutocomplete(containerElement, callback, options) {
    ...
    inputElement.addEventListener("input", function (e) {
        ...
        var promise = new Promise((resolve, reject) => {
            ...
            var apiKey = "1d08074b79e049318c6383004ba2a19d";
...
addressAutocomplete(document.getElementById("autocomplete-container"), (data) => {
    ...
    document.querySelector("#customerState").value = data.properties.state_code;
    document.querySelector("#customerZip").value = data.properties.postcode;

    console.log(data.properties.address_line1);
    console.log(data.properties.city);
    console.log(data.properties.statecode);
